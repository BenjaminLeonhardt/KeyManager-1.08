========================================================================
    KONSOLENANWENDUNG: KeyManager 1.01-Projektübersicht
========================================================================

Diese KeyManager 1.01-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre KeyManager 1.01-Anwendung besteht.


KeyManager 1.01.vcxproj
...
KeyManager 1.01.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen KeyManager 1.01.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
